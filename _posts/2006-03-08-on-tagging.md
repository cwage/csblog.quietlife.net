...
You can hopefully get a feel for how this will work on this blog by visiting the [tags page](</tags/>), which for now is just the previous categories we were using, converted to tags. Eventually, this will start to get fleshed out into a more meaningful representation of the sorts of things we post about.
