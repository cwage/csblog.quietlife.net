...
author: Chris
---
I realized I [mentioned](</2005/04/28/run-parts/>) this script previously, but never got around to actually posting it.
...
The [source can be found here](</wp-content/check-apt.txt>).
