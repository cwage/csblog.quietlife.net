...
author: Chris
---
I realized I [mentioned](<http://blog.centresource.com/2005/04/28/run-parts/>) this script previously, but never got around to actually posting it.
...
The [source can be found here](<http://blog.centresource.com/wp-content/check-apt.txt>).
