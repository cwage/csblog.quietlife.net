...
Each mixer has incorporated traditional interactive activities of hands-on competition through trivia, meet and greet score sheets, and coin hunts in competition for the coveted [Golden Kraut and Silvery Beans Awards](<https://web.archive.org/web/20090227164705/http://www.thegoldenkraut.com/>). Additionally, more "techie" interactive features have been utilized like wirelessly networked music throughout the house and live updating Twitter feeds using the #csmixer hashtag showing on big screens. More recently, the newly launched iPhone/iTouch application GPSAssassin has been a big hit, where people attempt to assassinate one another through GPS location used in the game.
