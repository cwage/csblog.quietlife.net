...
If you are interested in implementing this kind of functionality, you can see my code [here](<https://web.archive.org/web/20090930180012/http://brentertainment.com/2009/07/11/symfony-options-form-faux-form-serialization/>), or you can check out the code for [csDoctrineSlideshowPlugin](<https://web.archive.org/web/20090802204438/http://www.symfony-project.org/plugins/csDoctrineSlideshowPlugin>) and see it in action.
