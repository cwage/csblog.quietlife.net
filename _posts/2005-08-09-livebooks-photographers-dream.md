...
---
There are times when one encounters an idea so simple but elegant that you have to marvel at the person who envisioned it and saw it to completion. I've had such an encounter today with a site called [Live-Books](<http://www.live-books.com/>) (thank you Sunny) that allows Photographers to make their own online portfolios in a sleek, feature rich website.
...
All in all, I think this is a great service and it lends more [truth to my theory](<http://blog.centresource.com/2005/07/09/the-future-of-web-applications/>) that Flash will provide the next generation of web applications
