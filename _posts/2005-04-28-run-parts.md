...
---
[Debian](<http://www.debian.org/>) has some handy directories for dropping scripts into regular cron rotation, /etc/cron.hourly/, /etc/cron.daily/, /etc/cron.weekly/ and /etc/cron.monthly/.
