---
layout: post
title: "Digital Media:  The good, the bad, and the unproductive"
date: 2005-05-24
categories: [Operations]
---
Over the past five years, the consumer industry has rapidly embraced all forms of digital media and now acronyms such as MP2 and DVD are commonplace. Both the young and old play games on their computers, listen to music on their portable players, and watch movies in their home. If you're not in the entertainment industry, you may think you don't need to concern yourself with digital media, but you might be surprised. Digital media can affect your business in both good and bad ways.
...
If one employee is listening to Internet radio, it won't be long before others are doing the same. This also holds true for games. Small businesses can minimize this risk by implementing a clear policy that establishes guidelines and usage parameters for computing resources.

For businesses with more resource, additional measures are possible such as port blocking to stop Internet media streams and content filtering to block restricted Web sites. However, these measures require additional software and maintenance, so we recommend doing your own analysis to see if the expense is worth the savings.

**A New Hope: The benefits of Digital Media**

One of the most common forms of digital media is your Web site. As the next generation of Web sites emerges, businesses are using digital media such as the combination of flash and video to better present their services, products, and company image.

Some businesses use digital media on their Web site to better connect with visitors through features such as video and audio testimonials, and even full-length digital commercials.

Savvy businesses use those same digital creations beyond their Web site by displaying the same media at tradeshows, distributed on optical media such as DVDs, or even on CD-ROM business cards. Create it once - use it repeatedly and save money.

Organizations of all sizes now use [Adobe](<http://www.adobe.com/>)'s portable document format (PDF) digital media to replace their paper copies of important documents. This sample solution only requires a scanner and PDF conversion software to have a complete document imaging system.
...
Digital media is a brave new world for business; one that represents risks and rewards. Be proactive by protecting your organization from its risk, while embracing it for its powerful benefits!
