...
In conclusion, it looks like this product is not quite ready for the average user, and definitely not for a server. The lack of runtime/access scanning and inability to run as a service are what kills it here. It doesn't quite stack up well against a product like [AVG's Free Version](<https://web.archive.org/web/20050224150625/http://free.grisoft.com/>). Unfortunately, the licensing on a product like AVG's makes it unviable as an option for a for-profit company, so something like ClamWin looks very appealing. However, I don't think it's quite up to par. However, I am betting it won't be long.
