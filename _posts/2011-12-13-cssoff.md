...
---
[![](https://csblog.quietlife.net/wp-content/uploads/2011/12/CSSOFF2011-Design_small.png)](<https://csblog.quietlife.net/wp-content/uploads/2011/12/CSSOFF2011-Design_small.png> "CSSOff Design")Recently, [Unmatched Style](<http://unmatchedstyle.com/> "Unmatched Style") sponsored some "Friendly Markup Fisticuffs" where they issued design files to whoever wanted to compete, and the competitors would have two weeks to create a website using only their brains and their computers. The rules were pretty straightforward: one page only necessary, all external libraries (jQuery, et al.) had to be included, and your submission had to run locally. Otherwise, go nuts.
...
My entry: <https://web.archive.org/web/20111213/http://cssoff.csclientsite.com/troberts/>
