...
This comes on the heels of [Google Talk](</2006/01/17/google-talk-s2s-open/>), which last year launched its XMPP-based Google Talk service, opened it to XMPP s2s on the Internet. They also incorporated an (optional) user-friendly AJAX-based IM client into the gmail web client -- look for Livejournal to do the same, as well as integrating the blogging/comment-notification functions into instant messaging as well.
