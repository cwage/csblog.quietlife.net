...
author: Chris
---
The problem I alluded to in my [brief review](</2006/03/04/opera-90-tp2/>) of Opera 9.0 TP2 is simple: In the site-specific preferences, if you set the default to "Never accept cookies" -- it does just that, ignoring your site-specific exclusions. This appears to be because although the option to honor your site-specific prefs is still there, they just .. forgot to let you select it in the UI.
