...
In a previous article about [local spammers](</2005/04/28/localized-spammers/>), I mentioned that we typically figure out how we ended up on a list and then unsubscribe.
...
4) Their hosting company, [Websitesource.net](<https://web.archive.org/web/20050422044406/http://www.websitesource.net/>) has multiple abuse reports against it. [Click here](<http://groups-beta.google.com/group/news.admin.net-abuse.sightings/search?hl=en&group=news.admin.net-abuse.sightings&q=websitesource.net&qt_g=1&searchnow=Search+this+group>) for more details.
