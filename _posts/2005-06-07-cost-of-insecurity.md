...
Hm. An incentive to invest in better security? Or perhaps an incentive to simply not disclose vulnerabilities?
...
So this seems to indicate that from a financial perspective, the optimal time to disclose (if at all) is concurrent or immediately after a patch is made available.

And finally, on a more depressing note:
...
As King Louis XVI said, "It's good to be da king!"
