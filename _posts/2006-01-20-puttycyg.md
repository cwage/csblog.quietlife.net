...
author: Chris
---
I am a big fan of the [cygwin](<http://www.cygwin.com/>) suite of UNIX tools for windows, but one of my biggest annoyances was that the shell you run in cygwin is always displayed in the most horrid terminal environment (basically a glorified DOS window).

Enter [puttycyg](<http://gecko.gc.maricopa.edu/~medgar/puttycyg/>) -- it allows you to use [putty](<http://www.chiark.greenend.org.uk/~sgtatham/putty/>) as a raw terminal emulator (i.e. without telnet or ssh) in running your cygwin shell. From puttycyg's README:
