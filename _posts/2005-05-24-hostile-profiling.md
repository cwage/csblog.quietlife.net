...
author: Chris
---
Techweb [surveys](<https://web.archive.org/web/20080526083402/http://www.techweb.com/wire/security/163700240>) a technique that phishers/spammers/cretins are using to "hostilely" profile users using simple registration/password reminder processes on popular websites:
...
[Ebay](<https://web.archive.org/web/20050525004707/http://www.ebay.com/>) gets a gold star for evidently thwarting the password reminder attempt, using a practice that all web programmers should consider using as well:
