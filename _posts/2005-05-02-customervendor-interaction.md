...
I was reminded of this because of a bit of interaction I just had with [ValueWeb](<https://web.archive.org/web/20050507084221/http://www.valueweb.com/>). A customer was trying to get Valueweb to send me e-mail with a security code so that I could relay it to him so that he could change the contact info. However, I hadn't gotten the e-mail, so I called to clarify. After a bit of troubleshooting, it became obvious that their mail to me was being rejected by [Swirbo](<https://web.archive.org/web/20050508002246/http://www.swirbo.com/>) because their mailserver was misconfigured:
...
This of course has nothing to do with spam-filtering per se and more to do with their mailserver being misconfigured and sending "HELO lotusnotes", which is an egregious violation of the [SMTP RFC ](<https://web.archive.org/web/20050426232840/http://www.faqs.org/rfcs/rfc2821.html>)which specifies that you should send a FQDN (or a valid IP address) in the HELO command.
