...
author: Chris
---
Well, [wordverify](<https://web.archive.org/web/20060203025340/http://chris.quietlife.net/wordverify>) has taken care of almost all comment spam, except for [human spammers](<https://web.archive.org/web/20060518071051/http://blog.centresource.com/2006/01/27/advantage-consulting-services-spammers/>), of course.
...
Well, seeing as how this idea is so simple, I assumed rightly that I wasn't the first to have it. Indeed, Dan Sandler has already written a [fine plugin](<https://web.archive.org/web/20060206210520/http://idli.cs.rice.edu/~dsandler/trackback/trackback-validator-plugin/>) for Wordpress which does this exact thing.
