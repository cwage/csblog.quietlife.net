...
---
Undeadly is [reporting](<http://undeadly.org/cgi?action=article&sid=20050502152347>) that [OpenBSD 3.7](<http://www.openbsd.org/37.html#new>) CDs have begun arriving. Among the new features are some interesting ones:
...
In-kernel pppoe(4) support.
    This good news for me, as I use OpenBSD as my firewall and I'm thinking about moving to [butler.net](<http://www.butler.net/>)'s 3Mbps/384Kbps service, which requires PPPoE
