...
By far the most impressive accomplishment is the improvements in rendering, CSS, and Javascript. As I've noted before, the [ACID2 test results](<https://csblog.quietlife.net/2005/10/22/opera-90-preview-1-available/>) are amazing, and I have yet to find a site heavily using AJAX that doesn't work (I am sure there will be some, inevitably, but it's a good sign that Opera is no longer playing catchup to the AJAX boom.)
