...
Typically, when I get a comment spam that slips through our .htaccess checks and [wpblacklist](<http://sm.farook.org/WPBlacklist.htm>), I usually have to go to the wpblacklist options area and manually search for the URL they spammed and add the offending IP, host regex, etc.
...
I have seen this more and more. It appears to be a concerted effort by the comment/referer spammers to intersperse legitimate URLs along with the actual spam URLs. Presumably, the point is to get these legitimate URLs into blacklist databases and as a result diminish their reliability for not inducing false-positives. "Poisoning the well", so to speak. In the e-mail spam world, this is referred to as a [Joe-Job](<http://en.wikipedia.org/wiki/Joe_job>).
...
On [this thread](<http://blog.centresource.com/2005/08/28/tracking-down-the-source-of-referrer-spam/#comment-1374>), I suspected at first that we were the victim of such an attempt, as someone reported being referrer spammed with our URL. However, upon further investigation it appears to have merely been a [lame attempt at revenge](<http://blog.centresource.com/2005/08/28/tracking-down-the-source-of-referrer-spam/#comment-1381>) by our favorite referrer spammer himself, Jackie Zhao.
